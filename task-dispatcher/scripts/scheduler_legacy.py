#!/usr/bin/env python3
# DEPRECATED: This file has been superseded by scheduler_v2.py (Phase 2).
# Kept for backward compatibility only. New code should use scheduler_v2.py.
from __future__ import annotations
"""
scheduler.py - Task Dispatcher Scheduler (DEPRECATED — see scheduler_v2.py)
...
# ── Flow Type Templates ──
# DEPRECATED(v2): Role flow knowledge moved to pattern documents (role-flow/patterns/*.md).
# scheduler_v2.py does not use FLOW_TEMPLATES — kept here for v1 backward compatibility only.
FLOW_TEMPLATES = {
    "standard-dev": {
...
# DEPRECATED(v2): Flow transitions moved to pattern documents (role-flow/patterns/*.md).
# scheduler_v2.py does not use FLOW_TRANSITIONS — the Dispatcher agent reads pattern docs
# and decides next roles via LLM. Kept here for v1 backward compatibility only.
# next_action can be:
